...
//        }];
        ...
        $(function(){
            //加载页面时发送ajax请求获取添加毕业要求模板数据
            $.ajax({
                url:"/byyq/getAddByyqmbData",
                type:"post",
                data:{},
                dataType:"json",
                success:function(data){
                    ...
                    //alert(byyqVo[0].point[0].name);
                    //alert(courseVo[0].courseName);
            ...
            $("#save_btn").click(function(){
                ...
                //alert(courseIdPointIdQuanzhong.length);
                ...
                $.ajax({
                    url: "/byyq/saveByyqmb",
                    type: "post",
                    data: {"courseIdPointIdQuanzhong":courseIdPointIdQuanzhong, "byyqmbName":byyqmbName},
                    dataType: "json",
                    success: function (data) {
                        if(data == "1") {
                            alert("提交成功");
...
//                $.post("/byyq/saveByyqmb", {"id":"1"}, function(data){
//
//                }, 'json');
...
<body>
    ...
    <div style="text-align: center;padding: 10px;width: 100%;">
        ...
        <input style="font-size: 16px;width: 40%;text-align: center;" id="byyqmb_name" type="text" value="电子信息工程专业课程对应毕业要求二级指标点权重矩阵（2016级）"/>
    </div>
