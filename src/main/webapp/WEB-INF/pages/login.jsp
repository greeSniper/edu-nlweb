...
<body style="width:100%;">
	<div style="width:100%;height:60px;background-color: #0092DC;">
		<img style="margin-top: 3px;" src="${pageContext.request.contextPath }/images/logocslg.png" alt="logo" />
	</div>
	<div
		style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px;; margin-top: -280px;">
		<span style="float: right; margin-top: 35px; color: #488ED5;">常熟理工学院达成度评估系统</span>
	</div>
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginFunc">
				<div id="lbNormal" class="loginFuncMobile">教师登录</div>
			</div>
			<div class="loginForm">
