    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#import").click(function(){
                ...
                if(v){
                    //获取所选课程id
                    var courseId = $("input[name=courseId2]").val();

                    //校验完成后调用OCUpload插件的方法
                    $("#import").upload({
                        action:'/other/importOtherRes?courseId='+courseId,
                        name:'otherResFile',
...
<div class="easyui-window" title="下载哪个班级的模板？" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="searchForm" action="/other/downloaOtherTemplet" method="post">
            <table class="table-edit" width="80%" align="center">
                <tr class="title">
                    <td colspan="2">请选择班级和课程</td>
                </tr>
                <tr>
                    <td>班级</td>
                    <td>
...
<!-- 查询课程-->
<div class="easyui-window" title="上传哪门课程的其他成绩？" id="searchExpWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="ImportForm">
            <table class="table-edit" width="80%" align="center">
                <tr class="title">
                ...
                <tr>
                    <td>课程</td>
                    <td>
                        <input class="easyui-combobox" name="courseId2" required="true"
                               data-options="valueField:'id',textField:'courseName',mode:'remote',url:'/reach/findCourseListByTeacherId'" />
                    </td>
                </tr>
                <tr>
