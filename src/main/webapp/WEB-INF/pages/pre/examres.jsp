        ...
        $(function(){
            ...
            $("#import").click(function(){
                ...
                if(v){
                    ...
                    $("#import").upload({
                        action:'/reach/importExamRes?tpId='+tpId,
                        name:'examResFile',
...
<div class="easyui-window" title="下载哪个班级的模板？" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="searchForm" action="/reach/downloaTpTemplet" method="post">
...
<!-- 查询试卷-->
<div class="easyui-window" title="上传哪张试卷的成绩？" id="searchTpWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="ImportForm">
            <table class="table-edit" width="80%" align="center">
                <tr class="title">
                    <td colspan="2">请选择试卷</td>
                </tr>
                <tr>
                    <td>试卷</td>
                    <td>
