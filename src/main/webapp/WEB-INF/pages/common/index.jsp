...
<head>
	...
	<script type="text/javascript">
        ...
        $(function() {
            ...
            // 毕业要求管理菜单加载
            $.ajax({
                url : '${pageContext.request.contextPath}/json/byyq.json',
                type : 'POST',
                dataType : 'text',
                success : function(data) {
                    var zNodes = eval("(" + data + ")");
                    $.fn.zTree.init($("#byyqMenu"), setting, zNodes);
                },
                error : function(msg) {
                    alert('菜单加载异常!');
                }
        ...
        //进入前台页面
        function topre() {
            $.messager.confirm('系统提示','您确定要进入前台系统吗?',function(isConfirm) {
				if (isConfirm) {
					location.href = '${pageContext.request.contextPath }/page/topre';
				}
			});
		}
...
<div data-options="region:'west',split:true,title:'菜单导航'"
	...
	<div class="easyui-accordion" fit="true" border="false">
		<div title="毕业要求管理" data-options="iconCls:'icon-mini-add'" style="overflow:auto">
			<ul id="byyqMenu" class="ztree"></ul>
		</div>
		<div title="系统管理" data-options="iconCls:'icon-mini-add'" style="overflow:auto">
			<ul id="treeMenu" class="ztree"></ul>
		</div>
		<div title="人员管理" data-options="iconCls:'icon-mini-add'" style="overflow:auto">
